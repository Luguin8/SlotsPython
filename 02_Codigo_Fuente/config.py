...
FEATURE_WEIGHTS = [
    (SYM_H1, 1, 32.53), # Wild x1
    (SYM_H2, 2, 27.47), # Wild x2
    (SYM_H3, 2, 30.00), # Wild x2
    (SYM_H4, 3, 10.00)  # Wild x3
]

JP_SEEDS = {"MINI": 1000.0, "MINOR": 2000.0, "MAJOR": 3000.0}
JP_CONTRIBUTION = 0.5 

# --- 3. TABLA DE PAGOS (IGUAL A LA ANTERIOR) ---
PAYTABLE = {
...
# RIELES DE FREE SPINS "ENFRIADOS" (Ajuste para coincidir con 483%, 820%, etc.)
# Se han reemplazado algunas instancias de 5, 6, 7, 8 por 1 o 2.
FIXED_STRIPS_FS = [
    [5, 6, 1, 1, 6, 2, 7, 1, 7, 3, 11, 1, 4, 5, 7, 3, 1, 5, 4, 4, 1, 2, 2, 5, 2, 1, 5, 3, 4, 6, 4, 7, 1, 5, 7, 8, 3, 2, 3, 8, 5, 1, 8, 1, 4, 3, 6, 6, 1, 3, 8, 2, 2, 2, 7, 6, 4, 3, 11, 5, 1, 6, 7, 6, 4, 7, 3, 2, 4, 6],
    [2, 7, 2, 2, 1, 2, 4, 4, 8, 7, 6, 2, 6, 3, 4, 11, 1, 8, 7, 5, 5, 2, 6, 4, 3, 5, 4, 3, 5, 11, 6, 2, 3, 2, 1, 5, 4, 5, 8, 4, 1, 2, 6, 7, 3, 1, 5, 6, 6, 7, 8, 8, 1, 4, 3, 1, 1, 1, 3, 6, 7, 6, 1, 7, 7, 5, 4, 5, 3, 3],
    [2, 3, 3, 11, 6, 4, 1, 6, 3, 4, 8, 2, 2, 5, 5, 5, 7, 7, 7, 2, 2, 3, 3, 6, 6, 11, 1, 2, 6, 1, 2, 7, 7, 4, 3, 2, 1, 5, 5, 6, 6, 3, 5, 1, 7, 8, 8, 5, 4, 3, 4, 4, 1, 1, 4, 7, 1, 5, 8, 5, 4, 3, 2, 6, 1, 1, 7, 4, 1, 6],
    [8, 2, 5, 6, 2, 6, 4, 6, 11, 6, 6, 6, 1, 2, 5, 7, 7, 8, 1, 1, 4, 3, 4, 5, 2, 5, 3, 4, 6, 3, 4, 6, 7, 4, 4, 7, 3, 5, 2, 7, 3, 4, 7, 8, 3, 5, 1, 5, 6, 1, 2, 1, 5, 2, 3, 8, 2, 4, 2, 11, 8, 3, 3, 1, 1, 1, 1, 5, 7, 7],
    [3, 1, 2, 3, 8, 1, 6, 6, 7, 7, 4, 5, 4, 3, 4, 2, 2, 4, 5, 8, 6, 1, 6, 3, 3, 1, 5, 11, 8, 1, 3, 3, 3, 6, 2, 6, 7, 4, 1, 4, 4, 2, 7, 6, 7, 5, 7, 2, 6, 1, 2, 1, 4, 5, 6, 5, 2, 7, 2, 5, 1, 11, 5, 5, 7, 4, 8, 3, 8, 1]
]
