...
def export_project():
    ...
    # --- EXPORTAR RIELES ---
    write_strips_csv("Entregable_Reel_Strips_BASE.csv", strips_base, "JUEGO BASE (Sin Wilds, con Scatter)")
    write_strips_csv("Entregable_Reel_Strips_FS.csv", strips_fs, "GIROS GRATIS (Sin Wilds, con Scatter JP)")
