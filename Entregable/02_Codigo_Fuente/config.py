...
# --- 3. TABLA DE PAGOS (V24 - AJUSTE FINAL DE PRECISIÓN) ---
# ESTRATEGIA: Recuperar ~0.6% de RTP subiendo levemente los Highs.
PAYTABLE = {
    # Lows (MANTENEMOS IGUAL A V23 - Base sólida)
    SYM_L1: {3: 9, 4: 28, 5: 70},
    SYM_L2: {3: 9, 4: 28, 5: 70},   
    SYM_L3: {3: 14, 4: 38, 5: 100},
    SYM_L4: {3: 14, 4: 38, 5: 120},  
    
    # Highs (Pequeño boost para entrar en 96%+)
    SYM_H1: {3: 20, 4: 60, 5: 250}, 
    
    # H2 y H3: Subimos de 600 a 640 (+40 puntos)
    SYM_H2: {3: 35, 4: 100, 5: 640}, 
    SYM_H3: {3: 35, 4: 100, 5: 640}, 
    
    # H4: Subimos de 1500 a 1600 (+100 puntos)
